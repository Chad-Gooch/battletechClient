        ...
        <Table id="MechView" style={{width:'90%', margin:'auto', background:'rgba(169, 169, 169, 0.3)'}} dark>
            <thead>
                <tr>
                    ...
                    <td>walk</td>
                    <td>maxJet</td>
                    <td>head<div style={{width:'100px', padding:'0px', margin:'auto'}}>B E M S</div></td>
                    <td>Right Arm<div style={{width:'100px', padding:'0px', margin:'auto'}}>B E M S</div></td>
                    <td>Right Torso<div style={{width:'100px', padding:'0px', margin:'auto'}}>B E M S</div></td>
                    <td>Core<div style={{width:'100px', padding:'0px', margin:'auto'}}>B E M S</div></td>
                    <td>Left Torso<div style={{width:'100px', padding:'0px', margin:'auto'}}>B E M S</div></td>
                    <td>Left Arm<div style={{width:'100px', padding:'0px', margin:'auto'}}>B E M S</div></td>
                    <td>DLC</td>
                </tr>
            </thead>
            <tbody>
